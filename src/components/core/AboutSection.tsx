...
import { Shield, Users, Trophy, Target, ChevronLeft, ChevronRight, Gem } from "lucide-react";
            ...
            <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="container relative z-10 px-4 text-center perspective-1000">
                    <motion.div
                        ...
                        className="space-y-6"
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md max-w-full overflow-hidden">
                            <Gem className="h-4 w-4 text-blue-400 shrink-0" />
                            <span className="text-xs sm:text-sm font-medium text-slate-300 truncate">Premium Automotive Experience</span>
                        </div>
                        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-white tracking-tighter drop-shadow-2xl">
                ...
                <div className="container mx-auto max-w-7xl">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            >
                                <TiltCard className="h-[400px] w-full">
