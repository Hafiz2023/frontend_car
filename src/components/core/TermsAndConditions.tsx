        ...
        <div className="min-h-screen bg-slate-50 text-slate-600 pt-20">
            ...
            <div className="relative overflow-hidden bg-white py-20 sm:py-32 border-b border-slate-200">
                <div className="absolute inset-0 z-0 opacity-40">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-100 rounded-full blur-[120px]" />
                    <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-100 rounded-full blur-[120px]" />
                ...
                <div className="lg:grid lg:grid-cols-12 lg:gap-12">
                    ...
                    <aside className="hidden lg:col-span-3 lg:block">
                        <div className="sticky top-28 space-y-1">
                            <h3 className="mb-4 text-sm font-semibold text-slate-900 uppercase tracking-wider pl-4">Table of Contents</h3>
                            {sections.map((section) => (
                                ...
                                >
                                    <section.icon className={cn("h-4 w-4", activeSection === section.id ? "text-blue-600" : "text-slate-500")} />
                                    {section.title}
                                </button>
                            ))}
                            ...
                            <div className="pt-8">
                                <div className="rounded-xl bg-slate-900 border border-slate-800 p-5 shadow-lg">
                                    ...
                                    <Button variant="outline" size="sm" className="w-full border-slate-700 text-slate-300 hover:text-white hover:bg-slate-800 bg-transparent">Contact Support</Button>
                                </div>
                            </div>
                        </div>
                    </aside>
                    ...
                    <main className="lg:col-span-9 space-y-12">
                        ...
                        <section id="rental" className="scroll-mt-28">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-slate-900">2. Rental Policy & Requirements</h2>
                            </div>
                            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                <div className="grid gap-6 sm:grid-cols-2">
                                    <div>
                                        <h4 className="text-slate-900 font-semibold mb-2">Driver Requirements</h4>
                                        <p className="text-sm text-slate-500 leading-relaxed">Must be at least 25 years of age with a valid driver's license held for at least 2 years. International permits are required for non-residents.</p>
                                    </div>
                                    <div>
                                        <h4 className="text-slate-900 font-semibold mb-2">Security Deposit</h4>
                                        <p className="text-sm text-slate-500 leading-relaxed">A refundable security deposit of $1,000 - $5,000 is required depending on the vehicle class selected.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="liability" className="scroll-mt-28">
                            ...
                            <div className="text-slate-600 leading-relaxed space-y-4">
                                ...
                                <div className="rounded-lg border border-red-200 bg-red-50 p-4 text-sm text-red-800">
                                    <span className="font-semibold text-red-600">Important:</span> Use of vehicles for racing, off-roading, or ride-sharing services is strictly prohibited and voids all insurance coverage.
                                </div>
                            </div>
                        </section>
                        ...
                        {/* CTA */}
                        <div className="mt-16 rounded-3xl bg-slate-900 border border-slate-800 p-8 text-center relative overflow-hidden shadow-2xl">
                            ...
                            <p className="text-slate-400 mb-8 max-w-xl mx-auto relative z-10">By creating an account, you officially agree to these terms. Start your journey with VelocityX today.</p>
                            <Button size="lg" className="rounded-full px-8 bg-blue-600 hover:bg-blue-500 text-white relative z-10" asChild>
