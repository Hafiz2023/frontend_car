    ...
    return (
        <div className="min-h-screen bg-slate-50 pt-20 md:pt-24 pb-16 px-4 md:px-8">
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute top-0 right-1/4 w-[300px] h-[300px] md:w-[500px] md:h-[500px] bg-emerald-900/10 rounded-full blur-[80px] md:blur-[100px]" />
                <div className="absolute bottom-0 left-1/4 w-[300px] h-[300px] md:w-[500px] md:h-[500px] bg-blue-900/10 rounded-full blur-[80px] md:blur-[100px]" />
            </div>
                    ...
                    <div className="flex flex-col gap-4 lg:grid lg:grid-cols-[2fr,3fr,2fr] items-center">
                        ...
                        <div className="relative w-full">
                            ...
                            <Input
                                ...
                                className="pl-10 bg-slate-50 border-slate-200 text-slate-900 focus:ring-emerald-500/50 w-full"
                                value={searchTerm}
                        ...
                        <div className="flex w-full overflow-x-auto pb-2 lg:pb-0 scrollbar-hide gap-2 lg:justify-center">
                            {conditions.map((cond) => (
                                <button
                                    ...
                                    className={cn(
                                        "px-6 py-2 rounded-full text-sm font-medium transition-all whitespace-nowrap min-w-[80px] flex-shrink-0",
