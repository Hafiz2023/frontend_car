...
import { Loader2, ArrowRight, Car, User, Mail, Lock } from "lucide-react";
        ...
        <div className="flex min-h-screen w-full lg:grid lg:grid-cols-2 bg-[#020617] text-white overflow-hidden">
            ...
            <div className="relative hidden w-full flex-col p-10 lg:flex">
                ...
                <div
                    ...
                    style={{ backgroundImage: "url('https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?q=80&w=2560&auto=format&fit=crop')" }}
                >
                ...
                <div className="relative z-20 mt-auto max-w-lg">
                    <blockquote className="space-y-6">
                        <p className="text-3xl font-bold leading-tight">
                            "Join the exclusive community of automotive enthusiasts. Experience the future of car ownership today."
                        </p>
                        <footer className="flex items-center gap-4">
                            <div className="h-10 w-10 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 font-bold">SD</div>
                            <div>
                                <div className="font-semibold text-white">Sofia Davis</div>
                                <div className="text-sm text-blue-400">Top Verified Buyer</div>
                            </div>
                        </footer>
                    </blockquote>
                </div>
            ...
            <div className="flex flex-1 items-center justify-center p-8 lg:p-12 relative">
                ...
                <motion.div
                    ...
                    className="mx-auto flex w-full flex-col justify-center space-y-8 sm:w-[500px] relative z-10"
                >
                    ...
                    <div className="grid gap-6">
                        ...
                        <div className="flex items-center justify-center gap-2 mt-4 text-sm text-slate-400">
                            ...
                            <Link href="/auth/login" className="font-bold text-blue-500 hover:text-blue-400 flex items-center gap-1 transition-colors">
