...
const allCars = [
    ...
    },
    {
        ...
        type: "Sports",
        price: 300,
        image: "https://images.unsplash.com/photo-1503376763036-066120622c74?w=800&auto=format&fit=crop&q=80",
        seats: 2,
        fuel: "Petrol",
        transmission: "Manual",
        featured: true,
    ...
    return (
        <div className="min-h-screen bg-slate-50 pt-24 pb-16 px-4">
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-blue-900/10 rounded-full blur-[100px]" />
                <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-purple-900/10 rounded-full blur-[100px]" />
            </div>
                    ...
                    <div className="grid gap-6 lg:grid-cols-[2fr,3fr,2fr] items-center">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="pl-10 bg-slate-50 border-slate-200 text-slate-900 focus:ring-blue-500/50"
                                value={searchTerm}
